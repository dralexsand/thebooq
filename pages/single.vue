  ...
  <div>
    ...
    <div class="w-75 p-3 mb-1 text-dark">
      ...
      <p>
        ...
        Chev calls Doc Miles, who says that Chev has been fitted with an AbioCor artificial heart. Miles informs Chev that once the external battery pack runs out, the internal battery will kick in and he will have 60 minutes before it stops working. Chev crashes his car, destroying the external battery pack. After getting directions from a driver, Chev has the driver use jumper cables on him to charge the internal battery. At the club, Chev loses Vang but picks up a hooker named Ria, who sends him to a strip club where Vang is hiding out. In the club, Chev finds Eve, who is now working as a stripper. A group of Mexican mobsters, led by Chico, show up looking for Chev. After a gunfight, Chev learns that a mobster named "El Hurón" ("The Ferret") wants to kill him, but he doesn't find out why.
...
<script>
  ...
  import localmenu from '../components/helpers/localmenu'
